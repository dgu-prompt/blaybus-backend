    ...
    fun syncLeaderQuestData() {
        try {
            ...
            if (!values.isNullOrEmpty()) {
                ...
                val existingLeaderQuests = leaderQuestRepository.findAll().associateBy { it.questTitle to it.frequencyType }
    ...
    fun syncLeaderQuestProgressData() {
        try {
            ...
            if (!values.isNullOrEmpty()) {
                ...
                val progressList = mutableListOf<LeaderQuestProgress>()
                ...
                values.forEach { row ->
                    try {
                        ...
                        // User 조회
                        val users = usersRepository.findOptionalByEmployeeNumber(employeeNumber).orElseThrow {
                            Exception("User 객체를 찾을 수 없습니다. 사번: $employeeNumber")
                        }

                        // LeaderQuestProgress 생성
                        val leaderQuestProgress = LeaderQuestProgress(
                ...
                // 데이터 저장
                leaderQuestProgressRepository.saveAll(progressList)
