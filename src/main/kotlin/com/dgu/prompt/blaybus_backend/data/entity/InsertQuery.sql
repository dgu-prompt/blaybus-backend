...
VALUES
    (2010030101, '물류센터 최적화 시스템 개발', '물류센터 내 재고 관리 시스템의 효율화를 목표로 한 프로젝트', 12, CURRENT_TIMESTAMP, '2024-06-15'),
    (2014030201, '물류센터 최적화 시스템 개발', '물류센터 내 재고 관리 시스템의 효율화를 목표로 한 프로젝트', 12, CURRENT_TIMESTAMP, '2024-06-15'),
    (2014030201, '물류센터 안전 개선 작업', '물류센터의 작업 환경을 개선하여 안전 사고를 줄이는 프로젝트', 12, CURRENT_TIMESTAMP, '2024-09-05'),
